...
manual=(
"-b -e -n -s -t test_files/test1.txt"
"no_file.txt"
...
gnu=(
"-T test_files/test1.txt"
"-E test_files/test1.txt"
"--number test_files/test2.txt"
"--squeeze-blank test_files/test1.txt"
"--number-nonblank test_files/test2.txt"
"--number-nonblank --number --squeeze-blank -TE test_files/test1.txt"
)
run_test() {
