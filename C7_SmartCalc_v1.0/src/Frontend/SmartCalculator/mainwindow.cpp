...
void MainWindow::math_operations() {
  ...
  if (len_i > 0) {
    ...
    if (lastChar == '(') {
      ...
      inp.chop(1);
      fin.chop(2);
      ui->tab_result_mistakes->setText(fin);
  ...
  if (len_i > 0) {
    ...
    if (len_i > 1) {
      ...
      if (inp.endsWith("(pi)")) {
        ...
        ui->finish_line->setText(fin);
        ui->input_line->setText(inp);
      } else if (lastLastChar.isLetter() && inp.endsWith('(')) {
        fin.chop(1);
        if (inp.endsWith("atan(") || inp.endsWith("acos(") ||
            inp.endsWith("asin(") || inp.endsWith("sqrt(")) {
          inp.chop(5);
          fin.chop(6);
          ui->finish_line->setText(fin);
          ui->input_line->setText(inp);
        } else if (inp.endsWith("cos(") || inp.endsWith("sin(") ||
                   inp.endsWith("tan(") || inp.endsWith("log(")) {
          inp.chop(4);
          fin.chop(5);
          ui->finish_line->setText(fin);
          ui->input_line->setText(inp);
        } else if (inp.endsWith("ln(")) {
          inp.chop(3);
          fin.chop(5);
          ui->finish_line->setText(fin);
          ui->input_line->setText(inp);
        }
      } else if (fin.endsWith("|") && lastChar.isDigit()) {
        inp.chop(1);
        fin.chop(2);
        ui->finish_line->setText(fin);
        ui->input_line->setText(inp);
        ...
        ui->finish_line->setText(fin);
        ui->input_line->setText(inp);
      } else if (inp.endsWith("(") || inp.endsWith(")") || inp.endsWith("+") ||
                 inp.endsWith("-") || inp.endsWith("*") || inp.endsWith("/") ||
                 inp.endsWith("^")) {
        inp.chop(1);
        fin.chop(2);
        ui->finish_line->setText(fin);
        ui->input_line->setText(inp);
      } else if (inp.endsWith("mod")) {
        inp.chop(3);
        fin.chop(4);
        ui->finish_line->setText(fin);
        ui->input_line->setText(inp);
